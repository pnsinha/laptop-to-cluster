...
export function validatePageComposition(source: string, html: string): string[];
export function validateProjectionSourceAgreement(source: string, projectionHtml: string, canonicalSource: string, canonicalHtml: string): string[];
export function validateFrontendPolicy(manifest: any, astroConfig: string, sourceEntries?: Array<{ path: string; text: string }>): string[];
