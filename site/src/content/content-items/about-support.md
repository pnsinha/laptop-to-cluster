---
id: support-and-recovery
stable_slug: support
title: Support, issue reporting, and recovery
summary: "Public defect channels, reproducibility fields, channel fallback, and unavailable-artifact recovery scope."
artifact_type: support
route_namespace: about
topics: [recovery, support]
keywords: [accessibility, defects, issues, portability, recovery]
audiences: [all visitors, contributors]
milestone: 1
status: published
