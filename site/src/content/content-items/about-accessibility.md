...
stable_slug: accessibility
title: Accessibility
summary: "Accessibility approach, known status, and a public barrier-reporting path."
artifact_type: accessibility
route_namespace: about
topics: [accessibility]
keywords: [accessibility, keyboard, WCAG]
audiences: [all visitors]
milestone: 1
status: published
