...
summary: "Publication status and stable public locations for every July 31, 2026 foundation deliverable."
...
---
**Due:** July 31, 2026. This collection preserves each deliverable’s original publication status and stable URL; later changes are recorded as dated revisions rather than replacing completion history.

| Deliverable | Status | Public location |
|---|---|---|
| Externally hosted project site | Publication candidate | [Home](/) |
| Public companion repository and open licenses | Public | [Repository](https://github.com/pnsinha/laptop-to-cluster) and [licenses](/about/licenses/) |
